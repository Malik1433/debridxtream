        ...
        <div className="mod" style={{ minHeight: '100vh' }}>
            ...
            <div style={{ maxWidth: 760, margin: '0 auto', padding: '32px 24px' }}>
                ...
                <div style={{ display: 'grid', gap: 16, marginTop: 24 }}>
                    <button onClick={() => nav('/account/devices')} className="card" style={{ padding: 22, display: 'flex', gap: 14, alignItems: 'flex-start', textAlign: 'left', cursor: 'pointer', width: '100%', font: 'inherit' }}>
                        <MonitorSmartphone size={20} style={{ flex: 'none', marginTop: 2, opacity: 0.5 }} />
                        <div>
                            <h3 style={{ margin: '0 0 4px', fontSize: 16 }}>Your devices</h3>
                            <p style={{ margin: 0, fontSize: 14, opacity: 0.6 }}>See the TVs on this account, or add a new one with the code on its screen.</p>
                        </div>
                    </button>
