...
| ~~P23~~ | ✅ **DONE (`<p23>`)** — `PlayerMetadataBinder` (79): bindModernMetadata (poster/cleaned-title/S1·E2·SOURCE subtitle/quality pill). Views looked up on PlayerView per call (never fields). Thin Activity forwarder keeps the ~4 callers unchanged. baseline net 0 (351). Device .64: playback + first frame clean. | 2047 | done |
